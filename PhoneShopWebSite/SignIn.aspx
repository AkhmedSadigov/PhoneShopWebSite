<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignIn.aspx.cs" Inherits="PhoneShopWebSite.SignIn" %>
...
<body>
    <form id="form1" runat="server">
        <div>
           ...
           <div class ="navbar-collapse collapse">
                    <ul class ="nav navbar-nav navbar-right">
                        ...
                        <li class ="drodown">
                            <a href ="#" class ="dropdown-toggle" data-toggle="dropdown">Mobile Phones<b class ="caret"></b></a>
        ...
        <div class ="container ">
            <div class ="form-horizontal "><br /><br /><br /><br /><br />
                <h2>Login Form</h2>
                <hr />
